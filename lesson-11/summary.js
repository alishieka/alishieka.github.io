...
fetch(apiURL)
  ...
  .then((jsObject) => {
    ...
    document.getElementById('temperatureSoda').textContent = Math.round(jsObject.main.temp);
    ...
    document.getElementById('windSpeedSoda').textContent = Math.round(jsObject.wind.speed);
